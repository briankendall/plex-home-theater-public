...
namespace JSONRPC
{
  ...
  const char* const JSONRPC_SERVICE_TYPES[] = {  
    ...
    "\"GUI.Property.Name\": {"
      "\"type\": \"string\","
      "\"enum\": [ \"currentwindow\", \"currentcontrol\", \"currentcontrolinfo\", \"skin\", \"fullscreen\" ]"
    "}",
    "\"GUI.Property.Value\": {"
      "\"type\": \"object\","
      "\"properties\": {"
        ...
        "\"currentcontrol\": { \"type\": \"object\","
          ...
          "}"
        "},"
        "\"currentcontrolinfo\": { \"type\": \"object\","
          "\"properties\": {"
            ...
            "\"rowcount\": { \"type\": \"integer\", \"required\": false },"
            "\"columncount\": { \"type\": \"integer\", \"required\": false },"
            "\"itemcount\": { \"type\": \"integer\", \"required\": false }"
          "}"
        "},"
        "\"skin\": { \"type\": \"object\","
          "\"properties\": {"
  ...
  const char* const JSONRPC_SERVICE_NOTIFICATIONS[] = {  
    ...
    "\"GUI.OnFocusChanged\": {"
      "\"type\": \"notification\","
      "\"description\": \"The current focused control or window has changed.\","
      "\"params\": ["
        "{ \"name\": \"sender\", \"type\": \"string\", \"required\": true },"
        "{ \"name\": \"data\", \"type\": \"object\", \"required\": true,"
          "\"properties\": {"
